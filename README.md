...
Software engineer with **13 years of Java/J2EE experience**, now completing an **MS in Data Science (Nov 2026)**. I build full-stack applications, backend systems, and data pipelines.
...
`Java` `Spring Boot` `Python` `React` `SQL` `PySpark` `Azure Databricks` `scikit-learn` `RAG / LLMs` `REST APIs` `Kafka` `ETL`

## 📫 Connect

- [LinkedIn](https://www.linkedin.com/in/rima-sinha-59a5ba64)
